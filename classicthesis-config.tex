...
\titleformat{\chapter}[display]%
        {\relax}{\mbox{}\oldmarginpar{\vspace*{-
        3\baselineskip}\color{pruss!80}\chapterNumber\thechapter}}{0pt}%
        {\raggedright\spacedallcaps}[\normalsize\vspace*{.8\baselineskip}\prule]%
...
\areaset[current]{312pt}{700pt} % 686 (factor 2.2) + 33 head + 42 head \the\footskip
