...
\begin{enumerate}
    \item general-purpose analyses for autonomous abstraction and refinement,
    \item easy to design reusable abstract domains of all kinds,
    \item completely independent abstraction -- executable abstract programs.
\end{enumerate}

\noindent
In the following sections, I will state the main obstacles and objectives of
these goals. Further, I will explain how they relate to state-of-the-art
research.
