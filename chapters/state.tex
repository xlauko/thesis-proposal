...
name a few: Predator is a tool for automated verification of programs with
dynamic linked data structures using a separation logic and shape
graphs~\cite{Dudka2012}; Forester leverage tree automata in the combination
with shape analysis to verify programs with various types of lists or
trees~\cite{Holik2015}; whereas Space Invader~\cite{Yang2008} use shape
...
As in the case of abstraction with uninterpreted functions~\cite{Gange2016}, \textsc{smt} is also used to
