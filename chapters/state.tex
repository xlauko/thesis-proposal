...
It is possible to combine multiple domains to track multiple properties either
by tracking each property separately or by reduced product of domains which is
more precise and more efficient than multiple separate interpretations
\cite{Cousot2011b} (see \autoref{fig:cpsign}).  \add{find citation for
...
to simplify abstract operations \cite{Singh2017}, combination with interval
domain to reson about interval linear properties \cite{Chen2009}.
